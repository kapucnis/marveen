...
window._i18n.hu = {
  ...
  // --- Network / camera check ---
  'network.page_title':          'Hálózat',
  'network.page_subtitle':       'Kamera elérhetőség-ellenőrzés a helyi hálózaton',
  'network.ip_placeholder':      '192.168.x.x',
  'network.check_btn':           'Ellenőrzés',
  'network.checking':            'Ellenőrzés folyamatban...',
  'network.hint':                'Elérhetőség-teszt: azt mutatja, válaszol-e az eszköz a hálózaton, nem azt, hogy hibátlanul működik-e.',
  'network.result.isapi':        'Online -- Hikvision web-szolgáltatás válaszol ({ms}ms)',
  'network.result.isapi_noms':   'Online -- Hikvision web-szolgáltatás válaszol',
  'network.result.online_no_web':'Elérhető, de web-interfész nem válaszol',
  'network.result.offline':      'Nem elérhető',
  'network.result.busy':         'Egy ellenőrzés már folyamatban van, próbáld újra egy pillanat múlva.',
  'network.result.invalid_ip':   'Érvénytelen IP-cím.',
  ...
  'updates.toast.fork_short':    'Ez a telepítés divergens fork, az egykattintásos frissítés itt nem alkalmazható. Részletek lent.',
  'updates.fork.title':          'Divergens fork, az egykattintásos frissítés nem elérhető',
  'updates.fork.detail':         'A jelenlegi branch ({branch}) nincs az origin-on, így nincs upstream ref, amire a fast-forward frissítés hivatkozhatna. Ez a telepítés egy divergens fork. A frissítés valódi útja a fleet-update-watch folyamat (kategorizált SAFE telepítési terv, majd a Yoda/EliteAI merge-build-deploy kör), nem az egykattintásos pull.',
